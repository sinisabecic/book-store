...
?>
  ...
  <div class="col-lg-6">
    <div class="input-group">
      ...
      <input type="text" class="form-control" readonly value="<?php echo($result['name']) ?>">
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->

  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" readonly value="<?php echo($result['address']) ?>">
      <span class="input-group-btn">
...
<div class="row">
  <div class="col-lg-6">
    <div class="input-group">
      ...
      <input type="text" class="form-control" readonly value="<?php echo($result['city']) ?>">
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" readonly value="<?php echo($result['country']) ?>">
      <span class="input-group-btn">
...
<div class="row">
  <div class="col-lg-6">
    <div class="input-group">
      <span class="input-group-btn">
        <button class="btn btn-light" type="button">Postanski broj</button>
      </span>
      <input type="text" class="form-control" readonly value="<?php echo($result['zip']) ?>">
    </div><!-- /input-group -->
  </div><!-- /.col-lg-6 -->
  <div class="col-lg-6">
    <div class="input-group">
      <input type="text" class="form-control" readonly value="<?php echo($result['phone']) ?>">
      <span class="input-group-btn">
