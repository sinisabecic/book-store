      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="catlist.php"><i class="fa fa-circle-o"></i> Lista autora</a></li>
            <li><a href="catadd.php"><i class="fa fa-circle-o"></i> Dodaj autora</a></li>
          </ul>          
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="brandlist.php"><i class="fa fa-circle-o"></i> Lista izdavaca</a></li>
            <li><a href="brandadd.php"><i class="fa fa-circle-o"></i> Dodaj izdavaca</a></li>
          </ul>          
        </li> 
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="productlist.php"><i class="fa fa-circle-o"></i> Lista knjiga</a></li>
            <li><a href="productadd.php"><i class="fa fa-circle-o"></i> Dodaj knjigu</a></li>
          </ul>          
        </li> 
        ...
        <li class="">
          <a href="sliderlist.php">           
            <i class="fa fa-table"></i> <span>Slajder knjiga</span>            
          </a>                   
        </li>
