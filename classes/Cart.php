...
class Cart{
  ...
  public function updateCartQuantity($cartId, $quantity){
	...
	$query = "UPDATE tbl_cart
	            ...
	            if ($update_row) {
	            	...
	            	$msg = "<span class='error'><div class='alert alert-warning' role='alert'>Kolicina knjiga nije azurirana.</div></span> ";
	    			return $msg;
	            } 
  }
 ...
 $query = "DELETE FROM tbl_cart WHERE cartId ='$delId' ";
		  ...
		  if ($deldata) {
		  	...
		  	$msg = "<div class='alert alert-danger' role='alert'>Knjiga nije izbrisana iz porudzbine.</div>";
		    	 return $msg;
  			}
