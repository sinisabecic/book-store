...
public function brandInsert($brandName){
  ...
  Polje ne smije biti prazno! Pokusaj ponovo. <a href='brandlist.php' class='alert-link'> Vrati se na spisak izdavaca</a>.</div>";
    	 return $msg;
    	}else {
  ...
  Nije dodato! Pokusaj ponovo. <a href='brandlist.php' class='alert-link'> Vrati se na spisak izdavaca.</a></div></span> ";
    			return $msg;
    		}
    	}
  ...
  Uspjesno azurirano! <a href='brandlist.php' class='alert-link'>Vrati se</a>.
            	...
            	$msg = "<div class='alert alert-danger' role='alert'>
  Nije azurirano! Pokusaj ponovo. <a href='brandlist.php' class='alert-link'> Vrati se na spisak autora</a></div>";
    			return $msg;
            }
